...
ALTER TABLE l_account_transaction ADD CONSTRAINT l_account_transaction_pk PRIMARY KEY ( id );
...
ALTER TABLE l_account_transaction
    ADD CONSTRAINT h_account_l_account_transaction FOREIGN KEY ( account_id )
        REFERENCES h_account ( id )
            ON DELETE CASCADE;

--  ERROR: FK name length exceeds maximum allowed length(30) 
ALTER TABLE l_client_account_disposition
    ADD CONSTRAINT h_account_l_client_account_disposition FOREIGN KEY ( account_id )
        REFERENCES h_account ( id )
            ON DELETE CASCADE;
...
--  ERROR: FK name length exceeds maximum allowed length(30) 
ALTER TABLE l_client_account_disposition
    ADD CONSTRAINT h_client_l_client_account_disposition FOREIGN KEY ( client_id )
        REFERENCES h_client ( id )
            ON DELETE CASCADE;

ALTER TABLE l_client_demographic
    ADD CONSTRAINT h_client_l_client_demographic FOREIGN KEY ( client_id )
        REFERENCES h_client ( id )
            ON DELETE CASCADE;
...
ALTER TABLE l_disposition_credit_card
    ADD CONSTRAINT h_credit_card_l_card_disposition FOREIGN KEY ( card_id )
...
--  ERROR: FK name length exceeds maximum allowed length(30) 
ALTER TABLE l_client_demographic
    ADD CONSTRAINT h_demographic_l_client_demographic FOREIGN KEY ( demographic_id )
        REFERENCES h_demographic ( id )
            ON DELETE CASCADE;
...
--  ERROR: FK name length exceeds maximum allowed length(30) 
ALTER TABLE l_disposition_credit_card
    ADD CONSTRAINT h_disposition_l_card_disposition FOREIGN KEY ( disposition_id )
...
--  ERROR: FK name length exceeds maximum allowed length(30) 
ALTER TABLE l_account_transaction
    ADD CONSTRAINT h_transaction_l_account_transaction FOREIGN KEY ( transaction_id )
